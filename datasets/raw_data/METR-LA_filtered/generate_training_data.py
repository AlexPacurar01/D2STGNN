...
def generate_train_val_test(args):
    ...
    shutil.copy("datasets/METR-LA/test.npz", os.path.join(args.output_dir, "test.npz"))
...
if __name__ == "__main__":
    ...
    dataset         = "METR-LA_filtered"
    output_dir  = 'datasets/METR-LA_filtered'
    traffic_df_filename = 'datasets/raw_data/METR-LA_filtered/metr-la-filtered.h5'
